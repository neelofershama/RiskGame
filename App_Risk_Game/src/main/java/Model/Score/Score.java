...
public class Score {
    ...
    /**
     * @param territory Adds the territory to the list of player territories
     */
    ...
    /**
     * @param money Set the money owned by the player
     */
    ...
    /**
     * @param troop Add a troop to the list of players troop
     */
