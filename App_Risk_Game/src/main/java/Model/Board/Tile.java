...
public class Tile {
    ...
    /**
     * @param tile_name Update the tile name
     */
     ...
     */
	public void setTileType(String tile_type) {
    ...
    /**
     * @param x Associate x-coordinate of the tile
     */
    ...
    /**
     * @param y Associate y-coordinate of the tile
     */
    ...
    /**
     * @param neighbour_tile Associate neighboring tiles to the tile
     */
	public void setNeighbourTile(ArrayList<Tile> neighbour_tile) {
     ...
     */
    public ArrayList<String> getNeighbourTile() {
    ...
    /**
     * @param u Associates a unit to the tile
     */
    ...
    /**
     * @param u Removes the unit from the tile
     */
    ...
    /**
     * @param player_owned Associates a player to the tile
     */
	public void setPlayer(String player_owned) {
    ...
    /**
     * @param tile_value Associate a value to the tile
     */
	public void setTileValue(int tile_value) {
